...
public class NetConnection {
	...
	public NetConnection(final String url,final HttpMethod method,
						 final SuccessCallback successCallback,final FailCallback failCallback,final String sAction,final String ... kvs) {
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... arg0) {
				...
				paramsStr.append(sAction).append("?");
				...
				try {
					...
					default:
						...
						System.out.println("url+paramsStr.toString():"+url+paramsStr.toString());
