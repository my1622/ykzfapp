...
public class PictureActivity extends BaseActivity<UploadFilePresenter>
...
//                        .videoMinSecond(10)
    ...
    private void initImageShow() {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(PictureActivity.this, 2, GridLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(manager);
        adapter = new GridImageAdapter(PictureActivity.this, onAddPicClickListener);
        adapter.setList(selectList);
        adapter.setType("picture");
