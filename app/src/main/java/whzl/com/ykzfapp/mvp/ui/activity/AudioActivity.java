...
public class AudioActivity extends BaseActivity<UploadFilePresenter>
implements UploadFileContract.View{
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            PictureSelector.create(AudioActivity.this)
...
//                        .videoMinSecond(10)
    ...
    private void initImageShow() {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(AudioActivity.this, 2, GridLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(manager);
        adapter = new GridImageAdapter(AudioActivity.this, onAddPicClickListener);
        adapter.setList(selectList);
        adapter.setType("audio");
                ...
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(AudioActivity.this).externalPicturePreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(AudioActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(AudioActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(AudioActivity.this);
                } else {
