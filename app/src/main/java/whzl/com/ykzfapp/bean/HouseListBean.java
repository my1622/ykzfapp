...
public class HouseListBean extends BaseBean{
     ...
     * checkTel :
     * checkUserId : 1
     * communityAddress : 淮安市清河区北京北路199-24号
     * communityId : 1
     * communityName : 清河嘉园
     * contact : 丁
     * cookRooms : 1
    ...
    public void setDisStoreId(String disStoreId) {
    ...
    public void setDisStoreName(String disStoreName) {
        this.disStoreName = disStoreName;
    }
    ...
    public int getInfoStateUserId() {
        return infoStateUserId;
    }

    public void setInfoStateUserId(int infoStateUserId) {
        this.infoStateUserId = infoStateUserId;
    }
    ...
    public void setReleasedUserId(int releasedUserId) {
        this.releasedUserId = releasedUserId;
    }
    ...
    public void setTrustFlg(int trustFlg) {
